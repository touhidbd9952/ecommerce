...
<tr valign="top"><td height="25"><h2>Validate phone</h2></td></tr>
<tr valign="top">
<td>
<form action="<?php echo 'customercontroller/phoneverify/'.$cusid;?>" method='post' id='form' name='paymentform' accept-charset="utf-8">
