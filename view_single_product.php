		...
		<div class="container">
			<div class="breadcrumbs-main">
				<ol class="breadcrumb">
					...
					<li class="active">Our Products&nbsp;/&nbsp;<?php echo $catname?></li>
				</ol>
		...
		<div class="container">
			<div class="single-main">
					...
					<div class="col-md-7 single-top-right">
						...
						<h2><?php echo $title;?></h2>
                            ...
                            <script>
                            	...
                            	<form action="<?php echo 'main/addtocart'?>" method="post">
				...
				<div class="tabs col-md-12 col-sm-12 col-xs-12" style="margin:50px 0 0 0;padding:0;">
                    	...
                    	<ul class="tabs-list">
                            <li class="tab" id="descriptionTab"><a href="javascript:">Specification</a></li>
                     ...
                     <style>
						...
						{
							.ratingborder{border-right:1px solid #CCC;}
						}
                    ...
                    <div id="ratingReviews" class="tab-content" style="height:auto;">
                        ...
                        <div class="rating-bars col-md-4 col-sm-4 col-xs-12 ratingborder" style="margin-bottom:20px;">
                            ...
                            <li class="clearfix prd-ratingBarListItem">
								...
								{
								?>
                                <a href="javascript:" class="osh-btn -blue js-link-to-reviews"> <span class="ratingbtn " style="text-decoration:none">Write a Review</span> </a>
                                <?php
								}
								?>
                        		</div>
				...
				<div class="latestproducts col-md-12 col-sm-12 col-xs-12" style="padding:0px;">
					<div class="product-one">
                    	...
                    	<?php 
							$samotherpro = $this->db->query("SELECT *  FROM product where categoryid='".$sp->categoryid."' and id !='".$sp->id."' and stock !=0 limit 12 ")->result();
							$totalotherproduct = count($samotherpro);
						...
						<div class="col-md-4 product-left"> 
							<div class="product-main simpleCart_shelfItem">
								<a href="<?php echo 'main/view/'.$sop->id?>" class="mask"><?php if($image !=""){?><img class="img-responsive zoom-img" src="img/product/<?php echo $image;?>" alt="<?php if($sop->metatag !=""){echo $sop->metatag;}else{echo $sop->title;}?>" style="max-width:260px;max-height:260px;"><?php }?></a>
								<div class="product-bottom" style="text-align:center;">
									...
									<h4><a class="item_add" href="<?php echo 'main/view/'.$sop->id?>"><i></i></a> <span class=" item_price"><?php if(isset($sop->saleprice)&&$sop->saleprice!="") echo number_format($sop->saleprice,2)?>
								...
								<!--<div class="srch">
                                    <span><?php if($sop->discount=='0.00'){echo '0%';}else{ echo number_format($sop->discount,2).'%';}?></span>
								</div>-->
							</div>
						</div>
                    ...
                    <div class="bestseller">
						...
						?>
                         <div class="products-list" style="min-height:140px;">
                            ...
                            <span style="text-decoration:line-through;color:#F00;font-size:17px;font-family:'BreeSerif-Regular';padding-left:5px;">
								<?php 
                                if($bd->saleprice < $bd->regularprice)
                                {
                                ?>
                                <span style="text-decoration:line-through;color:#F00;font-size:17px;font-family:'BreeSerif-Regular';padding-left:5px;"><?php echo $bd->regularprice;?></span>  
                                <?php
                                }
                                ?>
                               </span> </span>
