...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <h2>Edit Role Create Form</h2>

<?php if(isset($_GET['emsg'])&& $_GET['emsg'] !="" )echo '<label class="em">'.$_GET['emsg'].'</label>';?>

<form action="<?php if($roleid !=""){echo 'acl_management/update_role';}?>" method="post">
	...
	<table>
                        	...
                        	<tr>
                            	<td>
									...
									?>
                                        ...
                                        <input type="checkbox" name="permissionlist[]" id="adminvar<?php echo $a;?>" <?php if(is_array($perm)&& in_array($p->id,$perm)){echo 'checked="checked"';}else if($p->id == $perm){echo 'checked="checked"';}?> value="<?php echo $p->id?>" />&nbsp;<?php echo '<span style="color:#000">'.$p->name.'</span>'?></div>
									<?php 
											}
										}
									?>
                        ...
                        <table class="tbl col-lg-12">
                        	<tr>
                            	<td>
									...
									?>
                                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
										<input type="checkbox" name="permissionlist[]" id="catalogvar<?php echo $b;?>" <?php if(is_array($perm)&& in_array($p->id,$perm)){echo 'checked="checked"';}else if($p->id == $perm){echo 'checked="checked"';}?> value="<?php echo $p->id?>" />&nbsp;<?php echo '<span style="color:#000">'.$p->name.'</span>'?>
                                    </div>
									<?php 
											}
										}
                         ...
                         <table class="tbl col-lg-12">
                        	<tr>
                            	<td>
									...
									?>
                                    	<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
										<input type="checkbox" name="permissionlist[]" id="customervar<?php echo $c;?>" <?php if(is_array($perm)&& in_array($p->id,$perm)){echo 'checked="checked"';}else if($p->id == $perm){echo 'checked="checked"';}?> value="<?php echo $p->id?>" />&nbsp;<?php echo '<span style="color:#000">'.$p->name.'</span>'?>
                                        </div>
									<?php 
											}
										}
                         ...
                         <table class="tbl col-lg-12">
                        	<tr>
                            	<td>
									...
									?>
                                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
										<input type="checkbox" name="permissionlist[]" id="salesvar<?php echo $d;?>" <?php if(is_array($perm)&& in_array($p->id,$perm)){echo 'checked="checked"';}else if($p->id == $perm){echo 'checked="checked"';}?> value="<?php echo $p->id?>" />&nbsp;<?php echo '<span style="color:#000">'.$p->name.'</span>'?>
                                    </div>
									<?php 
											}
										}
                        ...
                        <table class="tbl col-lg-12">
                        	<tr>
                            	<td>
									...
									?>
                                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
										<input type="checkbox" name="permissionlist[]" id="configurationvar<?php echo $e;?>" <?php if(is_array($perm)&& in_array($p->id,$perm)){echo 'checked="checked"';}else if($p->id == $perm){echo 'checked="checked"';}?> value="<?php echo $p->id?>" />&nbsp;<?php echo '<span style="color:#000">'.$p->name.'</span>'?>
                                    </div>
									<?php 
											}
										}
                          ...
                          <table class="tbl col-lg-12" >
                        	<tr>
                                ...
                                <div class="row">
									...
									?>
                                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
										<input type="checkbox" name="permissionlist[]" id="reportvar<?php echo $f;?>" <?php if(is_array($perm)&& in_array($p->id,$perm)){echo 'checked="checked"';}else if($p->id == $perm){echo 'checked="checked"';}?> value="<?php echo $p->id?>" />&nbsp;<?php echo '<span style="color:#000">'.$p->name.'</span>'?>
                                    </div>
									<?php 
											}
										}
        ...
        <tr>
        	<td>
                ...
                <input type="text" name="rolegroup" id="rolegroup" value="<?php if(isset($srr->group)&& $srr->group!="") echo $srr->group;?>" style="width:270px;" class="form-control">
            </td>
        </tr>
