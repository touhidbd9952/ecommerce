			...
			<div class="product-top">
				...
				?>
                                ...
                                <div class="col-md-3 product-left" style="margin-bottom:15px;">
                                    <div class="product-main simpleCart_shelfItem">
                                        <a href="<?php echo 'main/view/'.$apro->id?>" class="mask"><img class="zoom-img" src="img/product/<?php echo $apro->picture;?>" alt="<?php if($apro->metatag !=""){echo $apro->metatag;}else{echo $apro->title;}?>" style="max-width:260px;max-height:260px;"></a>
                                        <div class="product-bottom">
                                        	<div style="height:80px;overflow:hidden">
                                            <h3><?php echo $apro->title;?></h3>
                                            <p>Explore Now</p>
                                            </div>
                                            <h4><a class="item_add" href="#"><i></i></a> <span class=" item_price"><?php echo $price?>
                                            <?php 
               ...
               <?php    
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 m10">
                    ...
                    if($start > 1)
                    {
                        echo "<a href='".base_url()."main/bestseller?page=" . ($start-1)/$per_page . "' class='page'>PREV</a>";    // href='".  base_url(). "?page=" . ($start-1)/$per_page . "'
                    }
                    for($c =0;  $c < $productlist;$c++) 
                    {
                        if($count <= 30)
                        {
                            if($c%$per_page==0)
                            {
                                if(($end-1)/$per_page == $p)
                                {
                                    echo "<a href='".base_url()."main/bestseller?page={$p}' class='pgactive'>{$p}</a>";
                                }
                                else
                                {
                                    echo "<a href='".base_url()."main/bestseller?page={$p}' class='page'>{$p}</a>";
                                }
                                $p++;
                            }
                            $count++;
                    ...
                    if($end < $productlist)
                    {
                        echo '...'."<a href='".base_url()."main/bestseller?page=" . ((($end-1)/$per_page)+1) . "' class='page'>NEXT</a>";
                    }
                    ?>
                    </center>
              </div>
