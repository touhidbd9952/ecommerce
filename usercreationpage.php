...
function validation()
{
	...
	else
	{
		...
		if(isset($users)&& count($users)>0)
		{
			...
			{
		?>
			 if(username == '<?php echo $u->username; ?>')
			 {
				 userexist=1;
			 }
		<?php
	...
	else
	{
		...
		if(isset($users)&& count($users)>0)
		{
			...
			{
		?>
			 if(usercode == '<?php echo $u->access_code; ?>')
			 {
				 usercodeexist=1;
			 }
		<?php
...
<form action="<?php echo 'acl_management/create_user'?>" method="post" onsubmit="return validation()">
	...
	<table>
						...
						<div class="dropdown1">
						  ...
						  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width:100%;">
						   <div> 
							...
							?>
                           		<a class="dropdown-item" href="<?php echo 'acl_management/usercreate_form_with_permission/'.$r->id.'/'.urlencode($r->group);?>" ><?php echo $r->group?></a>
                             <?php 
    	...
    	<tr>
        	<td>  
                ...
                <input type="text" name="username" id="username" class="style-1 form-control">
            </td>
        </tr>
        <tr>
        	<td>
        ...
        <tr>
        	<td>  
                ...
                <input type="password" name="usercode" id="usercode" class="style-1 form-control">
            </td>
        </tr>
        <tr>
        	<td>
            	Name&nbsp;<span id="ename" class="em"></span><br />
                <input type="text" name="name" id="name" class="style-1 form-control">
            </td>
        </tr>
        <tr>
        	<td>
            	Address&nbsp;<span id="eaddress" class="em"></span><br />
                <textarea name="address" id="address" style="width:270px;" class="form-control"></textarea>
            </td>
        </tr>
        ...
        <tr>
        	<td>
                ...
                <input type="text" name="email" id="email" class="style-1 form-control">
            </td>
        </tr>
        ...
        <tr>
        	<td>
                ...
                <input type="text" name="phone" id="phone" class="style-1 form-control">
            </td>
        </tr>
