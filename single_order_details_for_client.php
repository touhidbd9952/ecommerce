...
.imgdiv{width:100px;}
.imgstyle{width:100px;height:80px;}
@media(max-width:767px)
{
	th,td{font-size:10px;}
	.imgdiv{width:50px;}
	.imgstyle{width:50px;height:40px;}
}
@media print
{  
	@page { margin: 0; }
...
<h3 style="margin:-15px 0px;">My Orders</h3>
<hr>		
          ...
          <?php 
			...
			foreach($customer as $c)
			{
				if($c->id == $customerid)
				{
					...
					$lastname = $c->lastname;
					if($lastname !=""){$name = $firstname.' '.$lastname;}else{$name = $firstname;}
					$email = $c->email;
					$phone = $c->phone;
					$country = $c->country;
         ...
         <div class="row">
         	<div class="col-md-9 col-sm-12 " style="border:1px solid #CCC;" >  
                  <div class="row">  
                     <div class="col-md-6 col-sm-6 ">
                        <div>
                            <table>
                                <tr><th colspan="3" style="text-align:left;text-transform:uppercase;color:#800000;">Payment Method :&nbsp;</th><th> <?php echo '<span style="color:#000;font-weight:normal;">'.$paysmethod.'</span>';?> </th></tr>
                            </table>
                        </div>
                     </div> 
                     <div class="col-md-6 col-sm-6 ">
                     	<div style="position:absolute;top:5px;right:20px;">
                            <table>
                                <tr><th style="text-align:left;text-transform:uppercase;color:#800000;">Delivery Location</th> <th>&nbsp;:&nbsp;</th> <td><?php echo $deliverylocation;?></td></tr>
                            </table>
                        </div>
                     </div>  
                 </div>
        ...
        <table class="table confirmtable table-condensed" style="background:#FFF;z-index:10000;margin-bottom:0px; width:100%;">
                              ...
                              <li style="list-style:none;">
                                ...
                                <td><?php if(isset($imagename)&& !empty($imagename)){?>
                                    <img src="<?php echo base_url().'img/product/'.$imagename?>"  class="imgstyle">
                                    <?php }?></td>
							  ...
							  ?>
                                ...
                                <td style="border:none;"></td>
                                <td style="border:none;"></td>
                                <td colspan="2"><span style="font-weight:bold;float:right;">Coupon:</span></td>
